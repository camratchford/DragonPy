...
class MX6309MemInfo(BaseMemoryInfo):
    """ For monitoring system-specific instructions. The base object has out_func, which can print or log to file. """
    MEM_INFO = (
...
def get_mx6309_meminfo():
    """ also pointless? """
    return MX6309MemInfo(log.debug)


if __name__ == "__main__":
    mem_info = MX6309MemInfo(print_out)
